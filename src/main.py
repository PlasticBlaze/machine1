"""
This was my initial openCV portion I wrote and was just using an iphone image to test the contour 
finding and stuff so I might have to redo some of it because now I'm using the depth camera
"""
...
# Parameters to update once the final design is established
